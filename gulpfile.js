...
gulp.task('d', gulp.series('clean', 'cssD', 'jsD', 'php', 'html', 'img', 'fonts', 'watch'))
gulp.task('p', gulp.series('clean', gulp.parallel('cssP', 'jsP', 'php', 'html', 'img', 'fonts')))
gulp.task('dx', gulp.series('clean', gulp.parallel('cssD', 'jsD', 'php', 'html', 'img', 'fonts')))